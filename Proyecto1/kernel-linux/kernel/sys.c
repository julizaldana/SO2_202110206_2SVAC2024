...
#include <linux/swap.h>    // Para obtener información de swap
#include <linux/vmstat.h>  // Para estadísticas de memoria
#include <linux/mmzone.h>  // Para acceso a zonas de memoria
